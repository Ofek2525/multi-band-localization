...
model_path = r"z_exp/2025-08-03_21:46#for_paper_3ues#tau =4 lr=0.0007,batch=12,ues=3,k=[20, 20, 20, 20],Nr=[4, 8, 16, 32],fc=[6000, 12000, 18000, 24000],BW=[4, 4, 4, 4],NS=50,input_power=-10.0dBm"
